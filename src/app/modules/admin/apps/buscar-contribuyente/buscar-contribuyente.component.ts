...
import { ContribuyenteModel, ContribuyentePagination } from '../contribuyente/contribuyentes.types';
...
export class BuscarContribuyenteComponent implements OnInit, AfterViewInit, OnDestroy
{
    @ViewChild(MatPaginator) private _paginator: MatPaginator;
    @ViewChild(MatSort) private _sort: MatSort;

    contribuyentes$: Observable<ContribuyenteModel[]>;
    //matDialogRef : MatDialogRef<BuscarContribuyenteComponent, any>;
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<BuscarContribuyenteComponent>
    )
    {
    }
