...
export class MenuService {
    ...
    private _estadosContrib: BehaviorSubject<OpcionModel[] | null> = new BehaviorSubject(null);
    private _tiposComprobs: BehaviorSubject<OpcionModel[] | null> = new BehaviorSubject(null);
