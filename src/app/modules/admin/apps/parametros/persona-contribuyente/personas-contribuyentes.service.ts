...
import { PersonaContribuyenteModel } from './personas-contribuyentes.types';
...
export class PersonaContribuyenteService {
     ...
     */
    getPersonaContribuyenteById(id: string): Observable<PersonaContribuyenteModel> {
 ...
 */
listarPersonasContribuyentes(): Observable<PersonaContribuyenteModel[]> {
    const headers = {
